...
para_template_biexp=c('gamma' = 1,betaEvent_intercept = -3,  betaEvent_trt = 0, alpha=2.5, 
                      ks_trt = 0.05,  ks_soc= 0.05, 
                      kg_trt=0.03, kg_soc=0.03, ks_omega = sqrt(0.8), kg_omega = sqrt(0.6 ), measure_sd= 0.09)
